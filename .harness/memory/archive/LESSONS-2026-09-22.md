# LESSONS archivadas — 2026-09-22 (T-041)

Curación de `.harness/memory/LESSONS.md`: las 14 lecciones más antiguas del
archivo (todas x1, de las tareas T-001 a T-009) no se repitieron en las 30+
tareas posteriores. Se archivan íntegras, sin editar su texto, para liberar
tope sin perder la información. Ver `.harness/memory/LESSONS.md` para las
lecciones vigentes.
