...
type Documents = {
    ...
    "\n  query PosAppointmentCheckoutInfo($id: ID!) {\n    appointment(id: $id) {\n      id\n      sale {\n        id\n        source\n        paymentStatus\n        paidTotalCents\n        totalCents\n        payments {\n          provider\n          processedAt\n          createdAt\n          note\n        }\n      }\n    }\n  }\n": typeof types.PosAppointmentCheckoutInfoDocument,
...
const documents: Documents = {
    ...
    "\n  mutation ApplyCouponToDraftSale($input: ApplyCouponToDraftSaleInput!) {\n    applyCouponToDraftSale(input: $input) {\n      subtotalCents\n      taxTotalCents\n      totalCents\n      appliedCoupons {\n        code\n        name\n        scope\n        discountAmountCents\n        rule {\n          type\n          discountBps\n          discountAmountCents\n          stackable\n          targetServiceIds\n          targetProductIds\n          targetCategoryIds\n        }\n      }\n      validationError {\n        valid\n        reason\n        message\n        computedDiscountCents\n      }\n    }\n  }\n": types.ApplyCouponToDraftSaleDocument,
    "\n  mutation RemoveCouponFromDraftSale($input: RemoveCouponFromDraftSaleInput!) {\n    removeCouponFromDraftSale(input: $input) {\n      subtotalCents\n      taxTotalCents\n      totalCents\n      appliedCoupons {\n        code\n        name\n        scope\n        discountAmountCents\n        rule {\n          type\n          discountBps\n          discountAmountCents\n          stackable\n          targetServiceIds\n          targetProductIds\n          targetCategoryIds\n        }\n      }\n    }\n  }\n": types.RemoveCouponFromDraftSaleDocument,
    "\n  query PosSaleDetail($id: ID!) {\n    sale(id: $id) {\n      id\n      createdAt\n      subtotalCents\n      taxTotalCents\n      totalCents\n      customer { id fullName }\n      payments { provider amountCents }\n      items { itemType qty unitPriceCents totalCents name staffUser { id fullName } }\n      couponApplications { code name discountAmountCents }\n    }\n  }\n": types.PosSaleDetailDocument,
    "\n  mutation ClockIn($locationId: ID!) { clockIn(locationId: $locationId) }\n": types.ClockInDocument,
    "\n  mutation ClockOut($locationId: ID!) { clockOut(locationId: $locationId) }\n": types.ClockOutDocument,
    "\n  query TimeClockEvents($staffUserId: ID!, $locationId: ID!, $fromDate: String!, $toDate: String!) {\n    timeClockEvents(staffUserId: $staffUserId, locationId: $locationId, fromDate: $fromDate, toDate: $toDate) {\n      id type at\n    }\n  }\n": types.TimeClockEventsDocument,
    "\n  query ShiftTemplates($staffUserId: ID!, $locationId: ID!) {\n    shiftTemplates(staffUserId: $staffUserId, locationId: $locationId) {\n      id staffUserId locationId dayOfWeek startMin endMin\n    }\n  }\n": types.ShiftTemplatesDocument,
    "\n  query PosLatenessRule($locationId: ID!) {\n    latenessRule(locationId: $locationId) {\n      id\n      locationId\n      defaultMinutesLateThreshold\n    }\n  }\n": types.PosLatenessRuleDocument,
    ...
    "\n  subscription PosHomeAppointmentUpdated($slug: String!) {\n    appointmentUpdated(slug: $slug) {\n      kind\n      appointmentId\n      locationSlug\n      occurredAt\n    }\n  }\n": types.PosHomeAppointmentUpdatedDocument,
    "\n  subscription PosHomeSaleEvent($slug: String!) {\n    saleEvent(slug: $slug) {\n      kind\n      saleId\n      locationSlug\n      occurredAt\n    }\n  }\n": types.PosHomeSaleEventDocument,
    ...
    "\n  mutation PauseWalkIn($walkInId: ID!) {\n    pauseWalkIn(walkInId: $walkInId) {\n      id\n      pausedAt\n    }\n  }\n": types.PauseWalkInDocument,
    "\n  mutation ResumeWalkIn($walkInId: ID!) {\n    resumeWalkIn(walkInId: $walkInId) {\n      id\n      pausedAt\n    }\n  }\n": types.ResumeWalkInDocument,
    "\n  mutation MarkWalkInNoShow($walkInId: ID!) {\n    markWalkInNoShow(walkInId: $walkInId) {\n      id\n      status\n    }\n  }\n": types.MarkWalkInNoShowDocument,
    "\n  mutation ReorderWalkIns($input: ReorderWalkInsInput!) {\n    reorderWalkIns(input: $input) {\n      id\n      sortOrder\n    }\n  }\n": types.ReorderWalkInsDocument,
    "\n  query SuggestedNextWalkIn($input: SuggestedNextWalkInInput!) {\n    suggestedNextWalkIn(input: $input) {\n      id\n      status\n      customerName\n      customer { id fullName }\n      requestedService { id name }\n      requestedServices { id name baseDurationMin }\n      requestedCatalogCombo { id name }\n      preferredStaffUserId\n      preferredStaffUser { id fullName photoUrl }\n      pausedAt\n      sortOrder\n      createdAt\n    }\n  }\n": types.SuggestedNextWalkInDocument,
};
