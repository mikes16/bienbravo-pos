...
export type PosAppointmentCheckoutInfoQuery = { __typename?: 'Query', appointment?: { __typename?: 'Appointment', id: string, staffNote?: string | null, sale?: { __typename?: 'Sale', id: string, source: string, paymentStatus: SalePaymentStatus, paidTotalCents: number, totalCents: number, payments?: Array<{ __typename?: 'PaymentTransaction', provider: PaymentProvider, processedAt?: string | null, createdAt: string, note?: string | null }> | null } | null } | null };
