...
export type PosProductsQuery = { __typename?: 'Query', products: Array<{ __typename?: 'Product', id: string, name: string, sku?: string | null, imageUrl?: string | null, categoryId?: string | null, sortOrder: number, isActive: boolean, variants: Array<{ __typename?: 'ProductVariant', id: string, priceCents: number }> }> };
