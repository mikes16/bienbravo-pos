...
const SAMPLE_LOCATIONS = [
  { id: 'loc1', name: 'Centro', slug: 'centro', timezone: 'America/Monterrey' },
  { id: 'loc2', name: 'Norte', slug: 'norte', timezone: 'America/Monterrey' },
  { id: 'loc3', name: 'Sur', slug: 'sur', timezone: 'America/Monterrey' },
]
